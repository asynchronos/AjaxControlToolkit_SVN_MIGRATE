...
<pre>&lt;ajaxToolkit:PasswordStrength ID="PS" runat="server"
    ...
    <em>CalculationWeightings="50;15;15;20"</em> /&gt;</pre>
        <ul>
            ...
            <li><strong>TextStrengthDescriptionStyles</strong> - List of CSS class names separated by a semi-colon that are applied to each Textual
                Strength description. The number of these items, must exactly match the number of text strength descriptions. If this
                property is not present, then the style defined in the TextCssClass property is used.</li>
