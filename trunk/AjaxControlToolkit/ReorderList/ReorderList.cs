        ...
        private void ExtractRowValues(IOrderedDictionary fieldValues, ReorderListItem item, bool includePrimaryKey, bool isAddOperation)
        {
            ...
            if (bindableTemplate != null)
            {
                ...
                foreach (DictionaryEntry entry in newValues)
                {
                    ...
                    //
                    if (includePrimaryKey || 0 != String.Compare((string)entry.Key, keyName, true, CultureInfo.InvariantCulture))
                    {
        ...
        protected override bool OnBubbleEvent(object source, EventArgs args)
        {
            ...
            if (ce != null)
            {
                ...
                if (ce.CommandArgument != null)
                {
                    ...
                    string command = ce.CommandName.ToString(CultureInfo.InvariantCulture).ToLower(CultureInfo.InvariantCulture);
