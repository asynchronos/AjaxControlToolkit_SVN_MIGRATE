...
namespace AjaxControlToolkit
{
    ...
    public class MaskedEditExtender : ExtenderControlBase
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            CultureTimePlaceholder = CultControl.DateTimeFormat.TimeSeparator;
            CultureDecimalPlaceholder = CultControl.NumberFormat.NumberDecimalSeparator;
            CultureThousandsPlaceholder = CultControl.NumberFormat.NumberGroupSeparator;
            ...
            CultureCurrencySymbolPlaceholder = CultControl.NumberFormat.CurrencySymbol;
            ...
            {
                CultureAMPMPlaceholder = CultControl.DateTimeFormat.AMDesignator + ";" + CultControl.DateTimeFormat.PMDesignator;
            }
        }
        ...
        public string CultureName
        {
            get
            {
                return GetPropertyValue<string>("Culture", "");
            }
            set
            {
                try
                {
                    if (!String.IsNullOrEmpty(value))
                    {
                        ...
                        SetPropertyValue<string>("Culture", CultControl.Name);
                        CultureDatePlaceholder = CultControl.DateTimeFormat.DateSeparator;
                        CultureTimePlaceholder = CultControl.DateTimeFormat.TimeSeparator;
                        CultureDecimalPlaceholder = CultControl.NumberFormat.NumberDecimalSeparator;
                        CultureThousandsPlaceholder = CultControl.NumberFormat.NumberGroupSeparator;
                    ...
                    {
                        SetPropertyValue<string>("Culture", "");
