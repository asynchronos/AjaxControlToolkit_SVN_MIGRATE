...
namespace AjaxControlToolkit
{
    ...
    public class PasswordStrength : ExtenderControlBase
    {
        ...
        private const string _txtDisplayStyles = "TextStringDescriptionStyles";
        ...
        public string TextStrengthDescriptionStyles
        {
            get
            {
                return GetPropertyValue(_txtDisplayStyles, "");
            }
            set
            {
                bool valid = false;
                if (!string.IsNullOrEmpty(value))
                {
                    ...
                    if (!string.IsNullOrEmpty(this.TextStrengthDescriptions))
                    {
                        string[] txtItems = this.TextStrengthDescriptions.Split(TXT_INDICATOR_DELIMITER);

                        if (txtItems.Length == styleItems.Length)
                        {
                            valid = true;
                        }
                    }
                ...
                if (valid)
                {
                    SetPropertyValue(_txtDisplayStyles, value);
                }
                else
                {
