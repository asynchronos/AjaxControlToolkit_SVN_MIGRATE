...
AjaxControlToolkit.PasswordStrengthExtenderBehavior = function(element) {
    ...
    this._txtStrengthDescriptionStyles = null;
    this._txtseparator = ';';
...
//        }
    ...
    _setBarDisplayLocation : function(outerElement, innerElement) {
        ...
        if (this.get_element().offsetHeight > 0) {
            ...
            if (this._displayPosition == AjaxControlToolkit.DisplayPosition.LeftSide)
            {
                ...
                var barBounds = $common.getBounds(outerElement);
    ...
    _showStrengthAsBarValue : function(strengthValue) {
        var bounds = $common.getBounds(this._barOuterDiv);
    ...
    _createTextDescriptions : function(descriptions) {
        ...
        if (this._txtStrengthDescriptionStyles != null && this._txtStrengthDescriptionStyles != "" )
            this._styleArray = this._txtStrengthDescriptionStyles.split(this._txtseparator);
...
//    },
    ...
    set_TextStrengthDescriptionStyles : function(value) {
        if (value != null && value != '' && value != this._txtStrengthDescriptionStyles) {
            this._txtStrengthDescriptionStyles = value;
            this.raisePropertyChanged('TextStrengthDescriptionStyles');
        }
    },
