...
//                this._handle.className = "ajax__slider_h_handle";
                ...
                this._handleImageUrl = '<%= WebResource("AjaxControlToolkit.Slider.Images.slider_h_handle.gif") %>'
                this._loadHandleImage();
            } else {
...
//                this._handle.className = "ajax__slider_v_handle";
                ...
                this._handleImageUrl = '<%= WebResource("AjaxControlToolkit.Slider.Images.slider_v_handle.gif") %>'
                this._loadHandleImage();
            }
//            this._initializeSlider();
        }
    ...
    _onHandleImageLoaded : function() {
        var handleImageBounds = $common.getBounds(this._handleImage);
