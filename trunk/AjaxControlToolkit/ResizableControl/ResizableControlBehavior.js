...
AjaxControlToolkit.ResizableControlBehavior = function(element) {
    /// <summary>
    ...
    /// </param>
    AjaxControlToolkit.ResizableControlBehavior.initializeBase(this, [element]);
...
AjaxControlToolkit.ResizableControlBehavior.prototype = {
    initialize : function() {
        ...
        /// </summary>
        AjaxControlToolkit.ResizableControlBehavior.callBaseMethod(this, 'initialize');

        this._frame = this.get_element();

        var savedSizeString = AjaxControlToolkit.ResizableControlBehavior.callBaseMethod(this, 'get_ClientState');
